...
const DEFAULT_UTILITY_TOOLS = [
  "6b5185d8-0878-4ee8-8e92-e8f50509af4d", // toggle_element
  "71132b94-7969-401b-bcda-f3ed43731e7b", // fill_field
  "a99739d5-a411-4601-a31f-c25e5eeb79ab", // click_element
  "b62c591a-56a1-4f6a-827d-248f6f5747d8", // scroll_page
  "0dfe2d2c-0c80-4d20-bb32-c84255627e83", // get_page_context
];
...
serve(async (req) => {
  ...
  try {
    ...
    if (tools.length > 0) {
      ...
      console.log(
        `🔧 Attaching ${tools.length} tools to assistant (${defaultToolsCount} default utility + ${dynamicToolsCount} dynamic tools)...`,
      );
      ...
      if (updateResponse.ok) {
        ...
        const dynamicToolsCount = tools.length - defaultToolsCount;
        console.log(
          `✅ Successfully attached ${tools.length} tools to assistant (${defaultToolsCount} default utility + ${dynamicToolsCount} dynamic tools)`,
        );
      } else {
