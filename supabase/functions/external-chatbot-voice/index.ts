...
serve(async (req) => {
  ...
  console.log('[CustomVoiceWidget] Loading universal voice widget...');
  ...
  class UniversalVoiceWidget {
    ...
    createWidget() {
      ...
      this.container.id = 'universal-voice-widget';
    ...
    initializeVapi() {
      try {
        ...
        console.error('[UniversalVoiceWidget] Init error:', error);
    ...
    setupVapiEvents() {
      ...
      this.vapi.on('error', (error) => {
        console.error('[UniversalVoiceWidget] Error:', error);
    ...
    async startCall() {
      try {
        ...
        await this.vapi.start({
          assistantId: this.config.assistant,
          backgroundDenoisingEnabled: false
        });
      } catch (error) {
        console.error('[UniversalVoiceWidget] Start call error:', error);
  ...
  new UniversalVoiceWidget(VAPI_CONFIG);
})();`;
    ...
    console.error('[EXTERNAL CHATBOT] Error:', error);
